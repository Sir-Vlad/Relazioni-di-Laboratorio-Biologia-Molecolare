...
\begin{enumerate}
	...
	\item Aggiungere una spatola di lisozima e Lasciare a temperatura ambiente per \qtyrange{20}{25}{\min}
	      ...
	      \end{Informazione}
	\item Aggiungere \qty{10}{\micro\litre} di \enzima{DNAsi} e \qty{10}{\milli\Molar} \ch{MgCl2}
	      \begin{myBox}
...
\begin{enumerate}
	...
	\item Aggiungere \qty{10}{\micro\litre} di \enzima{DNAsi} (stock \qty{20}{\mg\per\ml}). Questo enzima viene utilizzato per degradare il DNA.
	\item Aggiungere \qty{10}{\milli\Molar} \ch{MgCl2} (stock \qty{1}{\Molar}). È il cofattore della \enzima{DNasi} che ne permette il funzionamento.
	\item Incubare per \qty{10}{\min} a temperatura ambiente.
...
\photo{
	...
	\img{9-05}{\\LHC con aggiunta di \ch{MgCl2} e \enzima{DNAsi}}{9-05}{}
}{
